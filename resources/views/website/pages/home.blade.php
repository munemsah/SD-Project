...
<header class="bg-danger text-white">
    <div class="container text-center">
      <h1>Welcome to Alfa DIagnostic Center</h1>
      <marquee>Trusted and Friendly medical professionals</marquee>
      <a href="#" class="btn btn-success btn-xl rounded-pill mt-5">Learn More</a>
    </div>
  </header>
...
<h2 class="text-center text-succcess"> OUR LATEST TECHNOLOGY</h2>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        <div class="container-fluid">
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                <img class="card-img-top" src="{{ asset('images/201.jpg')}}" alt="Card image">
                <div class="card-body">
                </div>
              </div>
      </div>
        ...
        <div class="col-lg-4 col-md-4 col-12">
          <div class="card">
          <img class="card-img-top" src="{{ asset('images/202.jpg')}}" alt="Card image">
              <div class="card-body">
              </div>
          </div>
        </div>
          ...
          <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                <img class="card-img-top" src="{{ asset('images/203.jpg')}}" alt="Card image">
                    <div class="card-body">
                    </div>
                </div>
            </div>
	...
	<div class="col-lg-4 col-md-4 col-12">
	<div class="card">
  <img class="card-img-top" src="{{ asset('images/204.jpg')}}" alt="Card image">
  		<div class="card-body">
  			</div>
		</div>
	</div>
...
<div class="col-lg-4 col-md-4 col-12">
	<div class="card">
  <img class="card-img-top" src="{{ asset('images/205.jpg')}}" alt="Card image">
  		<div class="card-body">
  		</div>
	</div>
</div>
		...
		<div class="col-lg-4 col-md-4 col-12">
				<div class="card">
			  <img class="card-img-top" src="{{ asset('images/206.jpg')}}" alt="Card image">
				<div class="card-body">
					</div>
				</div>
			</div>
